...
const { getUserByName, getUserByNameProfile, createProfile, createUserProfile, updateUser,
  //  updateUserProfile,
  deleteUser, deleteUserProfile, suspendUser, unsuspendUser } = require('../src/controllers/chrController');
